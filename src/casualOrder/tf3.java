...
public class tf3 {
     ...
     * @throws Exception
     */
    public tf3(String serverPort, String config) throws Exception {
    	...
    	tf3.serverPort = Integer.parseInt(serverPort);

		tf3.serverAddr = InetAddress.getLocalHost().getHostAddress();

    	System.out.println("Server address: "+ tf3.serverAddr + " port: " + tf3.serverPort);

    	tf3.IPs = new HashMap<Integer, String>();
    	tf3.Ports = new HashMap<Integer, Integer>();
    	...
    	try (BufferedReader br = new BufferedReader(new FileReader(config))) {
    		...
    		while ((currLine = br.readLine()) != null) {
				...
				if (isFirst) {
					...
					if ((ip.equals(tf3.serverAddr) || ip.equals("localhost") || ip.equals("127.0.0.1")) && port == tf3.serverPort) {
						serverId = id;
					}
				}
			}
    ...
    public static void main(String[] args) throws Exception {
		...
		new tf3(args[0], "config_CA");

    	ServerSocket listener = new ServerSocket(tf3.serverPort);
